...
void forward(int timeMs)
{
  motor(1, BACKWARD, 255); //MAX speed
  motor(3, BACKWARD, 255); //MAX speed
  delay(timeMs);
  stop();
}

void backward(int timeMs)
{
  motor(1, BACKWARD, 255); //MAX speed
  motor(3, BACKWARD, 255); //MAX speed
  delay(timeMs);
...
void turn(int direction, int timeMs)
{
  if(direction==1)
  {
    motor(1, BACKWARD, 165); //MAX speed
    motor(3, FORWARD, 165); //MAX speed
  }
  else if(direction==2)
  {
    motor(1, FORWARD, 165); //MAX speed
    motor(3, BACKWARD, 165); //MAX speed
  }
  delay(timeMs);
  stop();
}
